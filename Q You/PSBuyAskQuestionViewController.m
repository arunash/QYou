//
//  PSBuyAskQuestionViewController.m
//  Q You
//
...
@interface PSBuyAskQuestionViewController ()
...
@implementation PSBuyAskQuestionViewController
...
- (IBAction)myQuestionPostButton:(UIButton *)sender {
    ...
    [newQuestion setObject:@"Buy" forKey:@"QuestionType"];
